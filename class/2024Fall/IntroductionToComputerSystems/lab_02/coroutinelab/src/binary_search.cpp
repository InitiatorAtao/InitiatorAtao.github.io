...
const size_t cache_miss_distance = 0x10;
...
uint32_t *naive(int m, int n, int batch, size_t log2_bytes, uint32_t *data) {
  ...
  freopen("data.csv", "a+", stdout);
  printf("%f,%f",(double)time_elapsed / m, (double)time_elapsed / m / log2_bytes);
